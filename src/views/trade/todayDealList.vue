        ...
        <Row :gutter="10">
            <Card>
                <Row v-if="!this.contract_id">
                    ...
                    <timeRange :vm="vm" dateName='makedeal_time' holderText="成交时间筛选" onlyTime="true"></timeRange>
                    </Col>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getList (params) {
                return this.util.ajax(this).post('v1/todayDealList', params).then(res => {
            ...
            create () {
                this.$refs.create.validate((valid) => {
                    ...
                    this.util.ajax(this).post('v1/todayDeal/create', this.createForm).then(res => {
            ...
            getInfo ($id, postParams, modalName) {
                this.util.ajax(this).post('v1/todayDealInfo/' + $id, postParams).then(res => {
                    this.info = res.data;
                    this[modalName] = true;
                });
            },
            ...
            update ($id, postParams, modalName) {
                this.util.ajax(this).post('v1/todayDeal/update/' + $id, postParams).then(res => {
                    if (modalName) {
